...
<<<<<<< HEAD
      ...
      <NotesTray
        ...
        onSelectUserNote={(friend) => setSelectedNoteUser(friend)}
      ...
      {isComposerOpen && (
        <NoteComposerModal
          ...
          existingNote={currentUser?.note}
          onShareNote={async (text, emoji, musicTrack, audience) => {
            await publishUserNote(text, emoji, musicTrack, audience);
      ...
      {/* Note View & Reply Modal */}
      {selectedNoteUser && selectedNoteUser.note && (
        <NoteActionModal
          user={selectedNoteUser}
          onClose={() => setSelectedNoteUser(null)}
          onSendReply={async (user, replyText) => {
            await sendNoteReply(user, replyText);
            setSelectedNoteUser(null);
          }}
          onOpenAudioHub={(track) => openAudioDetail(track)}
        />

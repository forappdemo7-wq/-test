            ...
            <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-sm sm:rounded-md px-8 py-8 shadow-sm">
              ...
              <div className="flex flex-col items-center mb-6">
                ...
                {(mode === 'signin' || mode === 'signup') && (
                  <div className="flex w-full mt-4 p-1 bg-neutral-100 dark:bg-neutral-800 rounded-lg text-xs font-semibold">
                    <button
                      id="tab-signin-btn"
                      type="button"
                      onClick={() => {
                      ...
                      className={`flex-1 py-2 rounded-md transition-all text-center cursor-pointer ${
                        mode === 'signin'
              ...
              {mode === 'signin' && (
                <form onSubmit={handleSignIn} className="flex flex-col gap-2.5">
                  ...
                  {/* Forgot Password */}
                  <div className="text-center mt-3 pt-2 border-t border-neutral-100 dark:border-neutral-800/80">
                    <button
                      type="button"
                      onClick={() => {
                        clearMessages();
                      ...
                      className="text-xs text-[#00376b] dark:text-sky-300 hover:underline cursor-pointer"
                    >
                      Forgot password?
                    </button>
                  </div>
              ...
              {mode === 'signup' && (
                <form onSubmit={handleSignUp} className="flex flex-col gap-2.5">
                  ...
                  <button
                    ...
                    className="w-full py-2 px-4 rounded bg-sky-500 hover:bg-sky-600 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-semibold transition-colors flex items-center justify-center gap-2 cursor-pointer"
                  >
                    {loading ? <Loader2 className="w-4 h-4 animate-spin" /> : 'Create New Account'}
                  </button>
                </form>
              )}
              ...
              {mode === 'signin' ? (
                <p className="text-neutral-700 dark:text-neutral-300">
                  ...
                  <button
                    ...
                    className="font-bold text-sky-500 hover:text-sky-600 focus:outline-none ml-1 cursor-pointer"
                  >
                    Create new account
                  </button>
                </p>

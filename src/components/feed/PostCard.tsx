...
<<<<<<< HEAD
          <div className="flex items-center gap-1.5 mt-1 flex-wrap">
            <button
              ...
              className={`flex items-center gap-2 text-xs px-2.5 py-1 rounded-full border transition-all cursor-pointer select-none max-w-fit ${
                isPlayingAudio
            ...
            <button
              type="button"
              onClick={() => openAudioDetail(post.musicTrack!)}
              className="text-[11px] font-semibold text-neutral-500 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-white px-2 py-0.5 rounded-full hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors cursor-pointer"
              title="View Audio Hub"
            >
              Audio Hub ↗
            </button>
          </div>
